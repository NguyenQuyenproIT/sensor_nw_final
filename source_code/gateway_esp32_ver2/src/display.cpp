...
void drawStaticUI()
{
    ...
    drawText(20, 12, "Sensor Networks", rgb565(255,255,0), bg, 2);
    drawText(20, 35, "--:--:--", rgb565(255,255,255), bg, 2);
    drawText(20, 55, "--/--/----", rgb565(180,180,180), bg, 2);

    drawText(20, 80, "HUMI :", rgb565(0,255,255), bg, 2);
    drawText(20, 115, "TEMP :", rgb565(255,0,0), bg, 2);
    drawText(20, 150, "SOIL :", rgb565(0,255,0), bg, 2);
    drawText(20, 200, "BOOTING", rgb565(255,255,255), bg, 3);
...
void updateTimeDisplay()
{
    ...
    {
        clearField(20, 30, 140, 24, bg);
        drawText(20, 35, timeStr, rgb565(255,255,255), bg, 2);
        prevTimeStr = timeStr;
    }

    if (dateStr != prevDateStr)
    {
        clearField(20, 50, 160, 24, bg);
        drawText(20, 55, dateStr, rgb565(180,180,180), bg, 2);
        prevDateStr = dateStr;
    }
}
...
void updateValues(float temp, float hum, int soil, const String &status)
{
    ...
    if (hum != prevHum)
    {
        clearField(110, 77, 120, 28, bg);
        drawText(110, 80, String(hum, 1) + " %", rgb565(0,255,255), bg, 2);
        prevHum = hum;
    }

    if (temp != prevTemp)
    {
        clearField(110, 112, 120, 28, bg);
        drawText(110, 115, String(temp, 1) + " C", rgb565(255,0,0), bg, 2);
        prevTemp = temp;
    }

    if (soil != prevSoil)
    {
        clearField(110, 147, 120, 28, bg);
        drawText(110, 150, String(soil) + " %", rgb565(0,255,0), bg, 2);
        prevSoil = soil;
    }

    if (status != prevStatus)
    {
        clearField(20, 196, 200, 40, bg);

        if (status == "WARNING")
            drawText(20, 200, "WARNING", rgb565(255,0,0), bg, 3);
        else if (status == "NORMAL")
            drawText(20, 200, "NORMAL", rgb565(0,255,0), bg, 3);
        else if (status == "MANUAL")
            drawText(20, 200, "MANUAL", rgb565(255,165,0), bg, 3);
        else if (status == "AUTO PUMP")
            drawText(20, 200, "AUTO PUMP", rgb565(255,165,0), bg, 3);
        else if (status == "TIMER")
            drawText(20, 200, "TIMER", rgb565(0,191,255), bg, 3);
        else
            drawText(20, 200, status, rgb565(255,255,255), bg, 3);
