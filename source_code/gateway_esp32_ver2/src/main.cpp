...
// #define STM_TIMEOUT_MS 10000UL

// String uartBuffer = "";
// unsigned long lastStmDataTime = 0;
...
//         Serial.println("STM32 TIMEOUT -> SENSOR ERROR");
...
//         Serial.println("SENSOR ERROR CLEARED -> RESTORE UI");
//     }
// }
...
//     bool gotValidFrameThisLoop = false;
...
//     // Only trigger error if we haven't got a valid frame within timeout
//     if (!gotValidFrameThisLoop && (millis() - lastStmDataTime >= STM_TIMEOUT_MS))
//     {
//         enterSensorError();
//     }
// }
